...
namespace Trading{
    LiquidityTaker::LiquidityTaker(Logger *logger, TradeEngine *trade_engine, FeatureEngine *feature_engine, OrderManger *order_manager, const TradeEngineCfgHashMap &ticker_cfg)
